...
//        if (arguments != null){
//            val str = arguments?.getString("userName", "")
//            root.txt.text = str
//        }

        root.txt.text = param1
...
//                    putString(ARG_PARAM2, param2)
    ...
    override fun onCreateAnimation(transit: Int, enter: Boolean, nextAnim: Int): Animation? {
        if (enter) {
            return MoveAnimation.create(MoveAnimation.UP, enter, 1500);
        } else {
            return CubeAnimation.create(CubeAnimation.UP, enter, 1500);
        }
    }
}